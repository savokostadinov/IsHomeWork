...
namespace EShop.Repository.Migrations
{
    ...
    [Migration("20230703194218_CinemaMigrations2")]
    partial class CinemaMigrations2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EShop.Domain.Identity.EShopApplicationUser3", b =>
                {
            ...
            modelBuilder.Entity("EShop.Domain.DomainModels.Order", b =>
                {
                    b.HasOne("EShop.Domain.Identity.EShopApplicationUser3", "User")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("EShop.Domain.DomainModels.ShoppingCart", b =>
                {
                    b.HasOne("EShop.Domain.Identity.EShopApplicationUser3", "Owner")
                        .WithOne("UserCart")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("EShop.Domain.Identity.EShopApplicationUser3", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
