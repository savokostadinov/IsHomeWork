...
namespace EShop.Web3.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public IActionResult AddProductToCard([Bind("SelectedProductId","Quantity")]AddToShoppingCartDto item)
        {
        ...
        public IActionResult Edit(Guid? pId)
        {
            ...
            var product = this._productService.GetDetailsForProduct(pId);
            if (product == null)
            {
                return NotFound();
            }
